...
hotel = pd.read_csv("Defi//data/hotel.csv")

sample = pd.read_csv("Defi/data/sample.csv")
...
df = pd.read_csv("Defi/data/dataset.csv")
...
print(df.columns)
sample.to_csv("Defi/data/ready_sample.csv")
df.to_csv("Defi/data/ready_data.csv")
